...
# Function to create a window and display an image
def create_window(title, image_path):
    window = tk.Tk()
    window.title(title)
...
# Create and display three windows with different images
create_window("Stock predictor 1", "img1.jpg")
create_window("Stock predictor 2", "img2.jpg")
create_window("Stock predictor 3", "img1.jpg")  # You can use the same image or different images
